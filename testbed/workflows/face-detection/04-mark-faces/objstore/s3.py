...
def download_file(s3_resource, source: ObjectStoreReference, dest_path: str) -> str:
    s3_resource.Bucket(source.bucket).Object(source.object_key).download_file(dest_path)
    return dest_path

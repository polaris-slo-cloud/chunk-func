...
BASE_SLO_MS=1144040 # fastest(scenario-01) + (cheapest(scenario-01) - fastest(scenario(01)) / 2
...
declare -A CMD_LINE_ARGUMENTS=(
    ["spread-search"]="--estimateMultiplier 1.5 --safetyMargin 0.01 --profileIncrements 2"
    ["hybrid-search"]="--estimateMultiplier 1.5 --safetyMargin 0.01 --profileIncrements 2"
)

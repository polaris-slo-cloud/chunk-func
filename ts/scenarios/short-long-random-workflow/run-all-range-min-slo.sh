...
## This base SLO gets us very close to the fastest possible time (3442171 ms).
BASE_SLO_MS=5736951 # fastest(scenario-01) + (cheapest(scenario-01) - fastest(scenario(01)) / 2
SLO_RANGE_PERCENT=40
SLO_STEP_PERCENT=1

WORKFLOW_PATH="workflow.yaml"
OUTPUT_DIR="./simulation-logs"
RESULTS_CSV="./simulation-results-min-slo.csv"
...
declare -A CMD_LINE_ARGUMENTS=(
    ["spread-search"]="--estimateMultiplier 1.4 --safetyMargin 0.01 --profileIncrements 1"
    ["hybrid-search"]="--estimateMultiplier 1.4 --safetyMargin 0.01 --profileIncrements 1"
)

...
BASE_SLO_MS=5172015 # fastest(scenario-01) + (cheapest(scenario-01) - fastest(scenario(01)) / 2
...
declare -A CMD_LINE_ARGUMENTS=(
    ["spread-search"]="--estimateMultiplier 1.0 --safetyMargin 0.07 --profileIncrements 1"
    ["hybrid-search"]="--estimateMultiplier 1.0 --safetyMargin 0.07 --profileIncrements 1"
)

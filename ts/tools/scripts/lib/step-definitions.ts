...
/** The validate-video-face-recog function from the face-detection workflow. */
export const shortFunctionStep: WorkflowStepDescription = {
...
/** The transform-video function from the face-detection workflow. */
export const mediumFunctionStep: WorkflowStepDescription = {
...
export const longFunctionStep: WorkflowStepDescription = {
    name: 'detect-faces',
    type: WorkflowStepType.Function,
    profilingResults: {
...
export const functionsAndInputs: FunctionAndInput[] = [
    { functionStep: shortFunctionStep, inputs: shortFunctionInputs },
    { functionStep: mediumFunctionStep, inputs: mediumFunctionInputs },
    { functionStep: longFunctionStep, inputs: longFunctionInputs },
];
